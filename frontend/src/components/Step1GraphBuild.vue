      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Working out who matters</span>
          </div>
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success">Done</span>
            <span v-else-if="currentPhase === 0" class="badge processing">Creating</span>
        ...
        <div class="card-content">
          <p class="description">
            Reads your documents and your question, and works out who and what matters in them.
          </p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || 'Reading your documents…' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Building the map</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="description">
            Builds a map of everyone involved, how they are connected, and what happened when.
          </p>
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">People and things</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Finished</span>
          </div>
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent">Working</span>
          </div>
        </div>
        
        <div class="card-content">
          <p class="description">Finished reading. Next: build the crowd.</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating…' : 'Next: build the crowd →' }}
          </button>
        </div>
      </div>
    </div>
