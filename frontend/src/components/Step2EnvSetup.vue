<template>
  <div class="env-setup-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Setting up the run</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">Done</span>
            <span v-else class="badge processing">Starting</span>
          </div>
        </div>
        
        <div class="card-content">
          <p class="description">
            Creates the run and loads the starting settings.
          </p>
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || 'Done' }}</span>
            </div>
          </div>
        </div>
      </div>

      <!-- Step 02: Create the people -->
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">02</span>
            <span class="step-title">Create the people</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="description">
            Turns the map into people, each with their own history, habits and opinions.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">People right now</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ expectedTotal || '-' }}</span>
              <span class="stat-label">People expected</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ totalTopicsCount }}</span>
              <span class="stat-label">Topics found so far</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">People created so far</span>
            </div>
            <div class="profiles-list">
              ...
              >
                ...
                <div class="profile-meta">
                  <span class="profile-profession">{{ profile.profession || 'Job not known' }}</span>
                </div>
                <p class="profile-bio">{{ profile.bio || 'Nothing written yet' }}</p>
      ...
      <!-- Step 03: Set up both platforms -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">Set up both platforms</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">Done</span>
            <span v-else-if="phase === 2" class="badge processing">Creating</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="description">
            Works out the settings for the run: how fast time moves, what the feed shows, and when each person is awake.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">How long</span>
                ...
                <div class="config-item">
                  <span class="config-item-label">Rounds</span>
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">Daytime</span>
                ...
                <div class="period-item">
                  <span class="period-label">Quiet</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Crowd settings</span>
              ...
              <div class="agents-cards">
                ...
                >
                  ...
                  <div class="agent-timeline">
                    <span class="timeline-label">Busy hours</span>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Reply delay</span>
                        <span class="param-value">{{ agent.response_delay_min }}-{{ agent.response_delay_max }}min</span>
                      </div>
                    </div>
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">How active</span>
                      ...
                      <div class="param-item">
                        <span class="param-label">Mood</span>
                        <span class="param-value" :class="agent.sentiment_bias > 0 ? 'positive' : agent.sentiment_bias < 0 ? 'negative' : 'neutral'">
                          {{ agent.sentiment_bias > 0 ? '+' : '' }}{{ agent.sentiment_bias?.toFixed(1) }}
                        </span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">Reach</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Feed settings</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Platform 1: the feed</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Weight on recency</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Weight on popularity</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Weight on relevance</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.relevance_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Goes-viral point</span>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Platform 2: groups</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Weight on recency</span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Working out the settings</span>
              </div>
      ...
      <!-- Step 04: Waking the crowd -->
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">04</span>
            <span class="step-title">Waking the crowd</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">Done</span>
            <span v-else-if="phase === 3" class="badge processing">Preparing</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="description">
            Creates the first few posts and topics that set the crowd going.
          </p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">Starting topics</span>
            ...
            <div class="initial-posts-section">
              <span class="box-label">Opening posts ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing">Working</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>

        <div class="card-content">
          <p class="description">The crowd is ready. You can start the run.</p>
          
          <!-- 模拟rounds数配置 - 只有在配置生成完成且rounds数计算出来后才显示 -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">How many rounds</span>
                <span class="section-desc">SpiderNet is planning the run <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours; each round is <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes pass</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>With 100 people, about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        With 100 people, about {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First time? Switch to Custom and lower the number of rounds. It finishes faster and is less likely to fail. →</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section">
            <span class="section-label">About them</span>
            <p class="section-bio">{{ selectedProfile.bio || 'Nothing written yet' }}</p>
          </div>

          <!-- 关注话题 -->
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Topics from your documents</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">Full background</span>
            
            <!-- 人设维度概览 -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">What happened to them</span>
                <span class="dim-desc">Everything they did, in order</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">How they behave</span>
                <span class="dim-desc">What they learned and how they act</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">What sticks with them</span>
                <span class="dim-desc">What they remember from your documents</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Who they know</span>
                <span class="dim-desc">Who knows whom</span>
              </div>
            </div>
...
// State
const phase = ref(0) // 0: Starting, 1: 生成人设, 2: 生成配置, 3: 完成
...
watch(currentStage, (newStage) => {
  if (newStage === '生成Agent人设' || newStage === 'generating_profiles') {
    ...
    if (!configTimer) {
      addLog('开始Set up both platforms...')
      startConfigPolling()
    }
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`开始模拟，Customrounds数: ${customMaxRounds.value} rounds`)
  } else {
    // 用户选择保持自动生成的rounds数，不传递 max_rounds 参数
    addLog(`开始模拟，使用自动配置rounds数: ${autoGeneratedRounds.value} rounds`)
  }
...
const startPrepareSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 立即设置People expected（从prepare接口返回值获取）
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        addLog(`→ Agent人设 ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || 'Job not known'})`)
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  ├─ How long: ${data.summary.simulation_hours}小时`)
        ...
        if (data.config.time_config) {
          ...
          addLog(`时间配置: 每rounds${tc.minutes_per_round}分钟, 共${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}rounds`)
        }
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        if (res.data.summary) {
          ...
          addLog(`  ├─ How long: ${res.data.summary.simulation_hours}小时`)
        ...
        // 配置尚未生成，开始rounds询
        addLog('配置Creating，开始rounds询Waiting...')
        startConfigPolling()
      }
    }
  } catch (err) {
